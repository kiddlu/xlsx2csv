...
def create_extreme_numbers_test():
    ...
    data = [
        ("Very large positive", 1.7976931348623157e308),
        ("Very large negative", -1.7976931348623157e308),
...
def create_stock_data_1107():
    ...
    for desc, val in [
        ("Very small positive", 1.23e-100),
        ("Very small negative", -4.56e-200),
        ("Tiny positive", 1e-300),
        ("Normal float", 123.456789),
    ]:
        ws4.append([desc, val])
