...
/* format_handler.c */
char *format_cell_value(const char *value, const char *type_attr, 
                        const char *style_attr, xlsx2csvConverter *conv);
...
int xlsx2csv_convert(xlsx2csvConverter *conv, const char *outfile, 
                     int sheetid, const char *sheetname);
